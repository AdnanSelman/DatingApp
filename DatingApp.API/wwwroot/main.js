...
var MessagesResolver = /** @class */ (function () {
    ...
    MessagesResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getMessages(this.authService.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error('Problem retriving messages');
            _this.router.navigate(['/home']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_31__["ListResolver"],
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
            src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], src_app_services_alertify_service__WEBPACK_IMPORTED_MODULE_3__["AlertifyService"]])
    ], MemberCardComponent);
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], src_app_services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"],
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(this.authService.decodedToken.nameid, this.user).subscribe(function (next) {
            _this.alertify.success('Profile updated successefully!!');
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]])
    ], RegisterComponent);
...
var appRoutes = [
    { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_3__["ListsComponent"], resolve: { users: _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_11__["ListResolver"] } },
        ]
    },
...
module.exports = __webpack_require__(/*! C:\Users\addna\Desktop\Angular\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
